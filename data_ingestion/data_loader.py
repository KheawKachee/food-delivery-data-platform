...
# LOAD JSON
users_df  = pd.read_json(os.path.join(DATA_PATH, "users.json"))
riders_df = pd.read_json(os.path.join(DATA_PATH, "riders.json"))
orders_df = pd.read_json(os.path.join(DATA_PATH, "orders.json"))
